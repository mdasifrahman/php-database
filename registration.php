...
<?php
		...
		if($_SERVER['REQUEST_METHOD']==="POST")
		{
			...
			if(empty($email ))
			{
				$emailErr="email cannot be invalid";
				$isValid=false;
			}
			if(empty($username ))
			{
...
<!doctype html>
	...
	<body >
        ...
        <fieldset>
			...
			<textarea id="comment" name="comment" rows="5" cols="15" value="<?php echo $presentaddress;?>"></textarea>
			<br> 
			<label for="comment1">Permanent  Address</label>
			<textarea id="comment1" name="comment0" rows="5" cols="10" value="<?php echo $permanentaddress;?>"></textarea>
			<br>
	...
	<span style="color:blue;"><?php echo $errorMessage ;?></span>
